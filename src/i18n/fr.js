  ...
  resources: {
    users: {
      ...
      fields: {
        ...
        status_filter_all: "Tout le monde",
        status_filter_deactivated: "Désactivés uniquement",
        status_filter_locked: "Verrouillés uniquement",
    ...
    rooms: {
      ...
      fields: {
        ...
        is_room_admin: "Administrateur du salon",
